...
public class BrewBatchService {
    ...
    private void apply(BrewBatch entity, BrewBatchRequest req) {
        ...
        entity.setOriginalGravity(req.getOriginalGravity() == null
                ? null
                : Math.floor(req.getOriginalGravity()));
        entity.setTargetFg(req.getTargetFg() == null
                ? null
                : Math.floor(req.getTargetFg()));
